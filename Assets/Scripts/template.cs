...
public class template : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        if(true){
            ...
            se.Append(s.DOMove(GameObject.Find("模板试剂").transform.position + new Vector3(0.02f , 0.2f,0) * 0.5f,1.5f));
            se.Append(s.DOMove(GameObject.Find("模板试剂").transform.position + new Vector3(0 , 0.05f,0) * 0.5f,1.5f));
