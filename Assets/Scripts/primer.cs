...
public class primer : MonoBehaviour
{
    ...
    // void OnGUI()
    // {
    //     GUI.Label(new Rect(290,220,40,40),"引物");
    // }
    void OnMouseUp()
    {
        Transform hat = GameObject.Find("Model/引物/盖").transform;
        ...
        se.Append(pipetee.DOMove(GameObject.Find("引物").transform.position + new Vector3(0.05f , 0.3f,0),1.5f));
        se.Append(pipetee.DOMove(GameObject.Find("引物").transform.position + new Vector3(0 , 0.05f,0),1.5f));
