...
public class polymerase : MonoBehaviour
{
    ...
    // void OnGUI()
    // {
    //     GUI.Label(new Rect(340,220,40,40),"DNA\n聚合酶");
    // }
    void OnMouseUp()
    {
        Transform hat = GameObject.Find("Model/DNA聚合酶/盖").transform;
        ...
        se.Append(pipetee.DOMove(GameObject.Find("DNA聚合酶").transform.position + new Vector3(0.05f , 0.3f,0),1.5f));
        se.Append(pipetee.DOMove(GameObject.Find("DNA聚合酶").transform.position + new Vector3(0 , 0.1f,0),1.5f));
